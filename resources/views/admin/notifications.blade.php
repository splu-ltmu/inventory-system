...
@section('content')
    ...
    <div style="margin-bottom:20px; display:flex; justify-content:space-between; align-items:center;">
        <p style="color:var(--muted); margin:0;">
            Stay updated on pending requests, system alerts, and client activity.
        </p>
            ...
            @foreach($notifications as $notification)
                <div class="notification-item {{ !$notification->read ? 'unread' : '' }}" 
                    ...
                    @php
                        ...
                        $bgColor = $bgColors[$notification->color] ?? 'var(--blue-light)';
                        $textColor = $textColors[$notification->color] ?? 'var(--blue)';
                    @endphp
                    
                    <div class="notification-icon" style="width:40px; height:40px; border-radius:50%; display:flex; align-items:center; justify-content:center; flex-shrink:0; background:{{ $bgColor }}; color:{{ $textColor }};">
