<?php $__env->startSection('content'); ?>
    ...
    <div class="monitoring-container">
        ...
        <div class="stats-grid">
            ...
            <div class="stat-card">
                <div class="stat-value"><?php echo e($activeMembers ?? 0); ?></div>
                <div class="stat-label">Active Members</div>
            </div>
            <div class="stat-card">
                <div class="stat-value"><?php echo e($totalDistributedItems ?? 0); ?></div>
        ...
        <?php if(isset($clientsWithMembers) && $clientsWithMembers->count() > 0): ?>
            <?php $__currentLoopData = $clientsWithMembers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="client-header">
                        <div class="client-info">
                            ...
                            <div>
                                ...
                                <div style="font-size: 12px; opacity: 0.8;">
                                    ...
                                    Members: <?php echo e($client->members_count ?? 0); ?>
                        ...
                        <div style="text-align: right;">
                            ...
                            <div style="font-size: 18px; font-weight: bold;">
                                <?php echo e($client->total_distributed_items ?? 0); ?>

                            </div>
                        </div>
                    </div>

                    <?php if(isset($client->members) && $client->members->count() > 0): ?>
                        <div class="settings-card">
                            <div class="card-header" onclick="toggleCard('members-<?php echo e($client->id); ?>')">
                                <h3>
                                    <span>👥</span>
                                    Members List
                                </h3>
                            ...
                            <div id="members-<?php echo e($client->id); ?>" class="card-content">
                                <table class="members-table">
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $client->members; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr data-member-name="<?php echo e(strtolower($member->name ?? '')); ?>" data-member-email="<?php echo e(strtolower($member->email ?? '')); ?>">
                                                <td style="font-weight: 600; color: #1e40af;">
                                                    <?php echo e($member->name ?? 'Unknown Member'); ?>

                                                </td>
                                                <td><?php echo e($member->email ?? 'No email'); ?></td>
                                                <td style="text-align: center; font-weight: 600;">
                                                    <?php echo e($member->distributed_items ?? 0); ?>

                                                </td>
                                                <td style="text-align: center; font-weight: 600; color: #059669;">
                                                    <?php echo e($member->available_items ?? 0); ?>

                                                </td>
                                                <td style="text-align: center; font-weight: 600; color: #d97706;">
                                                    <?php echo e($member->used_items ?? 0); ?>

                                                </td>
                                                <td style="text-align: center;">
                                                    <span class="member-badge <?php echo e(($member->available_items ?? 0) > 0 ? 'member-active' : 'member-inactive'); ?>">
                                                        <?php echo e(($member->available_items ?? 0) > 0 ? 'Active' : 'Inactive'); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/admin/member-settings.blade.php ENDPATH**/ ?>