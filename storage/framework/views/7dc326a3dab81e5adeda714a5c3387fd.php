...
<div class="toolbar">
    ...
    <a class="btn-link" href="<?php echo e(route('categories.index')); ?>">Back to Categories</a>
</div>
...
<div class="form-container">
    ...
    <form action="<?php echo e(route('categories.update', $category->id)); ?>" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" name="name" id="name" value="<?php echo e(old('name', $category->name)); ?>" placeholder="e.g., Computer Supplies" required>
        </div>

        <div class="form-group">
            <label for="code">Code:</label>
            <input type="text" name="code" id="code" value="<?php echo e(old('code', $category->code)); ?>" placeholder="e.g., CS" maxlength="2" style="text-transform: uppercase;" required>
        </div>

        <div class="form-actions">
            <button type="submit" class="btn-submit">Update Category</button>
            <a href="<?php echo e(route('categories.index')); ?>" class="btn-cancel">Cancel</a>
        </div>
    </form>
</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/admin/categories/edit.blade.php ENDPATH**/ ?>