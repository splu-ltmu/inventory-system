...
<head>
    ...
    <title>Request Password Reset - Inventory System</title>
...
<body>
    <div class="login-container">
        ...
        <div class="info-text">
            Submit a password reset request. An administrator will review and reset your password shortly.
        </div>
        ...
        <form method="POST" action="<?php echo e(route('password-reset.submit')); ?>">
            ...
            <div class="form-group">
                ...
                <textarea id="reason" name="reason" placeholder="Tell us why you need a password reset..." rows="4"></textarea>
            </div>
        ...
        <div class="login-footer">
            <p><a href="/client/login">← Back to login</a></p>
        </div>
    </div>
</body>
</html>
<?php /**PATH /var/www/resources/views/auth/password-reset-request.blade.php ENDPATH**/ ?>