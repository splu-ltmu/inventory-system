    ...
    <tbody>
        <?php $__empty_1 = true; $__currentLoopData = $inbounds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <tr>
                ...
                <td><?php echo e($row->unit ?? 'pcs'); ?></td>
                <td class="tc"><?php echo e($row->total ?? 0); ?></td>
                <td><?php echo e($row->category_name ?? '—'); ?></td>
                <td><?php echo e(\Carbon\Carbon::parse($row->created_at)->format('M d, Y')); ?></td>
            </tr>
...
<?php /**PATH /var/www/resources/views/admin/inbound-report-pdf.blade.php ENDPATH**/ ?>