    ...
    <div id="topNotifDropdown" class="dropdown" role="menu" aria-hidden="true">
        ...
        <div class="notifications-list">
            <?php if($totalPending > 0): ?>
                ...
                <?php if($recentClients > 0): ?>
                    <a href="/admin/clients" class="notification-item <?php echo e($recentClients > 0 ? 'unread' : ''); ?>">
                        ...
                        <div class="notification-content">
                            ...
                            <div class="notification-message"><?php echo e($recentClients); ?> new client<?php echo e($recentClients !== 1 ? 's' : ''); ?> registered in last 24 hours</div>
                            <div class="notification-time">Welcome new clients</div>
                        </div>
                        <div class="notification-count"><?php echo e($recentClients); ?></div>
                    </a>
                <?php endif; ?>
...
<?php endif; ?><?php /**PATH /var/www/resources/views/partials/top-notifications.blade.php ENDPATH**/ ?>