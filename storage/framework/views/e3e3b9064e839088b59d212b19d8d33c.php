...
<body>
    <div class="reset-container">
        ...
        <form method="POST" action="<?php echo e(route('password-reset.update', ['token' => $token])); ?>">
            <?php echo csrf_field(); ?>

            <div class="form-group">
                <label for="email">Email Address</label>
                <input type="email" id="email" value="<?php echo e($email); ?>" disabled>
            </div>
...
<?php /**PATH /var/www/resources/views/auth/password-reset-form.blade.php ENDPATH**/ ?>