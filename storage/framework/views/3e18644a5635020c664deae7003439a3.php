    ...
    <div class="card-body" style="position:relative;">
        <div style="display:flex; justify-content:space-between; align-items:flex-start; gap:12px; flex-wrap:wrap;">
            ...
            <form id="filterForm" method="GET" style="display:flex; gap:10px; align-items:center; flex-wrap:wrap; margin-top:4px;">
                        ...
                        <a
                            href="<?php echo e(route('admin.summary.report.pdf')); ?>?<?php echo e(http_build_query(request()->only(['q', 'office', 'date_from', 'date_to']))); ?>"
                            class="btn-submit"
                    ...
                    <table class="summary-table">
                        ...
                        <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $stockSummaries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td><?php echo e($row['item']); ?> <?php if($row['id_no']): ?> <span class="muted">(<?php echo e($row['id_no']); ?>)</span><?php endif; ?></td>
                                        <td class="numeric"><?php echo e(number_format($row['starting_balance'])); ?></td>
                                        <td class="numeric"><?php echo e(number_format($row['inbound'])); ?></td>
                                        <td class="numeric"><?php echo e(number_format($row['sum'])); ?></td>
                                        <td class="numeric"><?php echo e(number_format($row['outbound'])); ?></td>
                                        <td class="numeric"><?php echo e(number_format($row['ending_balance'])); ?></td>
                                    </tr>
