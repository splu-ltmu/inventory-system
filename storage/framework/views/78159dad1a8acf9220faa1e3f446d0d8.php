...
<body>
    <div class="login-container">
        ...
        <form method="POST" action="<?php echo e(route('client.login.submit')); ?>" onsubmit="showLoading('Signing in...')">
            <?php echo csrf_field(); ?>
    ...
    >
        ...
        <div class="login-footer">
            <p style="text-align: center;"><a href="<?php echo e(route('password-reset.request')); ?>">Forgot your password?</a></p>
        </div>
    </div>
...
<?php /**PATH /var/www/resources/views/auth/client-login.blade.php ENDPATH**/ ?>