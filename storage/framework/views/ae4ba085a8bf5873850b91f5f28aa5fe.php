...
<div class="toolbar">
    ...
    <a class="btn-link" href="<?php echo e(route('inbound.index')); ?>">Back to Inbound</a>
</div>
...
<div class="form-container">
    ...
    <form action="<?php echo e(route('inbound.store')); ?>" method="POST" id="inboundForm">
        ...
        <div class="form-actions">
            ...
            <a href="<?php echo e(route('inbound.index')); ?>" class="btn-cancel">Cancel</a>
        </div>
    </form>
</div>
...
(function(){
    ...
    async function fetchSuggestions(query) {
        ...
        try {
            const response = await fetch(`<?php echo e(route('inbound.suggestions')); ?>?q=${encodeURIComponent(query)}`);
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/admin/inbound/create.blade.php ENDPATH**/ ?>