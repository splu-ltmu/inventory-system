...
<div class="toolbar">
    ...
    <a class="btn-link" href="<?php echo e(route('outbound.index')); ?>">Back to Outbound</a>
</div>
...
<div class="form-container">
    ...
    <form action="<?php echo e(route('outbound.store')); ?>" method="POST">
        <?php echo csrf_field(); ?>
        ...
        <div class="form-group">
            ...
            <select name="stock_id" id="stock_id" required>
                ...
                <?php $__currentLoopData = $stocks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stock): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($stock->id); ?>" data-available="<?php echo e($stock->stock); ?>" <?php echo e(old('stock_id') == $stock->id ? 'selected' : ''); ?>><?php echo e($stock->description); ?> (<?php echo e($stock->id_no); ?>)</option>
        ...
        <div class="form-group">
            ...
            <div style="position:relative;">
                <input 
                    ...
                    value="<?php echo e(old('recipient_search', '')); ?>" 
            ...
            <?php $__errorArgs = ['recipient_search'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><span style="color:#ef4444;font-size:12px;"><?php echo e($message); ?></span><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group">
            ...
            <input type="text" name="office" id="office" value="<?php echo e(old('office', '')); ?>" placeholder="e.g., TMU, HR Department" required>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group">
            ...
            <input type="number" name="total" id="total" value="<?php echo e(old('total', 1)); ?>" min="1" required>
        </div>
        ...
        <div class="form-actions">
            ...
            <a href="<?php echo e(route('outbound.index')); ?>" class="btn-cancel">Cancel</a>
        </div>
    </form>
</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/admin/outbound/create.blade.php ENDPATH**/ ?>