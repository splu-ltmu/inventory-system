...
<?php $__env->startSection('content'); ?>
    ...
    <div class="monitoring-container">
        ...
        <div class="stats-grid">
            ...
            <div class="stat-card">
                <div class="stat-value"><?php echo e($totalMembers ?? 0); ?></div>
        ...
        <?php if(isset($clientsWithFullData) && $clientsWithFullData->count() > 0): ?>
            <?php $__currentLoopData = $clientsWithFullData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="client-section" 
                     data-client-name="<?php echo e(strtolower($client->name ?? '')); ?>" 
                     data-client-office="<?php echo e(strtolower($client->office ?? '')); ?>"
                     data-member-names="<?php echo e(strtolower($client->members->pluck('name')->implode(' '))); ?>"
                     data-member-emails="<?php echo e(strtolower($client->members->pluck('email')->implode(' '))); ?>"
                     onclick="openClientModal(<?php echo e($client->id); ?>, '<?php echo e($client->name ?? 'Unknown Client'); ?>', '<?php echo e($client->office ?? 'Not specified'); ?>', '<?php echo e($client->email ?? 'No email'); ?>', <?php echo e($client->inventory_items_count ?? 0); ?>, <?php echo e($client->members_count ?? 0); ?>, <?php echo e($client->total_available_inventory ?? 0); ?>)">
                    ...
                    <div class="client-list-item">
                        ...
                        <div class="client-stats">
                            <div class="stat-item">
                                <span>📦</span>
                                <span class="stat-value"><?php echo e($client->total_available_inventory ?? 0); ?></span>
                                <span>items</span>
                            </div>
                            <div class="stat-item">
                                <span>👥</span>
                                <span class="stat-value"><?php echo e($client->members_count ?? 0); ?></span>
                                <span>members</span>
                            </div>
                        </div>
                    </div>
    ...
    <?php $__currentLoopData = $clientsWithFullData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php $__currentLoopData = $client->members; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php
            ...
            <!-- Backdrop -->
            <div id="admin-member-items-backdrop-<?php echo e($client->id); ?>-<?php echo e($member->id); ?>" 
                 ...
                 onclick="toggleAdminMemberItemsDropdown('admin-member-items-<?php echo e($client->id); ?>-<?php echo e($member->id); ?>')">
            </div>
            
            <!-- Popup Window -->
            <div id="admin-member-items-<?php echo e($client->id); ?>-<?php echo e($member->id); ?>" 
                ...
                <div style="display:flex; align-items:center; justify-content:space-between; padding:16px 20px; background:linear-gradient(135deg, #3b82f6, #1d4ed8); color:white; border-radius:12px 12px 0 0;">
                    <div>
                        <div style="font-weight:700; color:#fff; font-size:16px;"><?php echo e($member->name ?? 'Unknown Member'); ?></div>
                        <div style="color:rgba(255,255,255,0.8); font-size:13px; margin-top:2px;"><?php echo e($member->email ?? 'No email'); ?></div>
                        <div style="color:rgba(255,255,255,0.7); font-size:11px; margin-top:2px;">Client: <?php echo e($client->name ?? 'Unknown Client'); ?></div>
                    </div>
                    <button type="button" onclick="toggleAdminMemberItemsDropdown('admin-member-items-<?php echo e($client->id); ?>-<?php echo e($member->id); ?>')" style="background:none; border:none; color:rgba(255,255,255,0.8); cursor:pointer; padding:6px 8px; border-radius:6px; font-size:20px; line-height:1;" onmouseover="this.style.background='rgba(255,255,255,0.1)'" onmouseout="this.style.background='none'">×</button>
                </div>
                ...
                <div style="max-height:300px; overflow-y:auto; pointer-events:auto;" onclick="event.stopPropagation();">
                    ...
                    <?php if($distributedItems->count() > 0): ?>
                        <div style="padding:8px 12px;">
                            ...
                            <?php $__currentLoopData = $distributedItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div style="padding:8px; margin-bottom:6px; border:1px solid #e5e7eb; border-radius:6px; background:#f9fafb;">
                                    ...
                                    <div style="display:flex; gap:12px; font-size:11px; color:#6b7280;">
                                        ...
                                        <span><strong>Used:</strong> <span style="color:#d97706; font-weight:600;"><?php echo e($item->used_qty); ?></span></span>
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                ...
                <div style="padding:16px; background:#f8fafc; border-radius:0 0 12px 12px; border-top:1px solid #e2e8f0;">
                    <div style="font-size:12px; color:#64748b; text-align:center;">
                        ...
                        <div style="font-size:13px;">
                            Total Received: <?php echo e($member->distributed_items); ?> | 
                            Total Used: <?php echo e($member->used_items); ?> | 
                            <span style="color:#059669; font-weight:700;">Available: <?php echo e($member->available_items); ?></span>
                        </div>
                                            </div>
                </div>
            </div>
    ...
    <script>
        ...
        <?php $__currentLoopData = $clientsWithFullData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            clientsData[<?php echo e($client->id); ?>] = {
                id: <?php echo e($client->id); ?>,
                name: '<?php echo e($client->name ?? "Unknown Client"); ?>',
                office: '<?php echo e($client->office ?? "Not specified"); ?>',
                email: '<?php echo e($client->email ?? "No email"); ?>',
                inventory_items: <?php echo json_encode($client->inventory_items, 15, 512) ?>,
                members: <?php echo json_encode($client->members, 15, 512) ?>,
                inventory_items_count: <?php echo e($client->inventory_items_count ?? 0); ?>,
                members_count: <?php echo e($client->members_count ?? 0); ?>,
                total_available_inventory: <?php echo e($client->total_available_inventory ?? 0); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/admin/client-monitoring.blade.php ENDPATH**/ ?>