...
<div class="form-container">
    ...
    <form action="<?php echo e(route('categories.store')); ?>" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" name="name" id="name" value="<?php echo e(old('name')); ?>" placeholder="e.g., Computer Supplies" required>
        </div>

        <div class="form-group">
            <label for="code">Code:</label>
            <input type="text" name="code" id="code" value="<?php echo e(old('code')); ?>" placeholder="e.g., CS" maxlength="2" style="text-transform: uppercase;" required>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/admin/categories/create.blade.php ENDPATH**/ ?>