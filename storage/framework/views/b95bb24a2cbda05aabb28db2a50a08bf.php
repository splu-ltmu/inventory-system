...
<head>
    ...
    *{ box-sizing:border-box; }
    ...
    body{
        ...
        min-height:100vh;
        padding:20px;
        background-image: url('/images/building.jpg.JPG?v=<?php echo e(time()); ?>');
...
<body>
    <div class="login-container">
        ...
        <form method="POST" action="<?php echo e(route('admin.login.submit')); ?>" onsubmit="showLoading('Signing in...')">
            <?php echo csrf_field(); ?>
    ...
    >
        ...
        <div class="login-footer">
            <p style="text-align: center;"><a href="<?php echo e(route('admin.password-reset-self.form')); ?>">Forgot your password?</a></p>
        </div>
    </div>
...
<?php /**PATH /var/www/resources/views/auth/admin-login.blade.php ENDPATH**/ ?>