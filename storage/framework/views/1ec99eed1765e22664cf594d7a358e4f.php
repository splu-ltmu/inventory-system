    ...
    <div id="clientNotifDropdown" class="dropdown" role="menu" aria-hidden="true">
        ...
        <div class="notifications-list">
            <?php if($totalPending > 0): ?>
                ...
                <?php if($memberActivity > 0): ?>
                    <a href="<?php echo e(route('client.account', ['tab' => 'members'])); ?>" class="notification-item <?php echo e($memberActivity > 0 ? 'unread' : ''); ?>">
                        ...
                        <div class="notification-content">
                            ...
                            <div class="notification-message"><?php echo e($memberActivity); ?> member<?php echo e($memberActivity !== 1 ? 's' : ''); ?> added recently</div>
                            <div class="notification-time">Manage team members</div>
                        </div>
                        <div class="notification-count"><?php echo e($memberActivity); ?></div>
                    </a>
                <?php endif; ?>
            <?php else: ?>
...
<?php endif; ?>
<?php /**PATH /var/www/resources/views/partials/client-notifications.blade.php ENDPATH**/ ?>