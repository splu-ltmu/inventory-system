...
<?php $__empty_1 = true; $__currentLoopData = $groupedByDate; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dateKey => $dateGroup): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
    <h3 style="margin-top:20px; margin-bottom:12px; color:var(--text); font-size:16px; font-weight:700;">
        <?php echo e($dateKey !== 'No Date' ? \Carbon\Carbon::parse($dateKey)->format('F d, Y') : 'No Date'); ?>
    ...
    <?php $__empty_2 = true; $__currentLoopData = $grouped; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $groupKey => $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
        ...
        <div class="ob-card" data-client="<?php echo e(strtolower($clientName)); ?>" data-office="<?php echo e(strtolower($clientOffice)); ?>">
            <div class="ob-header" onclick="toggleOb('<?php echo e($obid); ?>')">
                <div style="flex:1;">
                    <div class="ob-title"><?php echo e($clientName); ?></div>
                    <div class="ob-sub"><?php echo e($clientOffice); ?> • <?php echo e($group->count()); ?> item<?php echo e($group->count() !== 1 ? 's' : ''); ?></div>
                </div>

                <div class="ob-header-right">
                    <div class="ob-count" style="text-align:right;">
                        <div class="ob-date" style="font-weight:700;"><?php echo e($groupDate); ?></div>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $group; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr style="border-bottom:1px solid #e0e7ff; background:linear-gradient(135deg, #ffffff, #f8fafc);">
                                    ...
                                    <td style="padding:14px 10px; border-bottom:1px solid #e0e7ff; color:#475569; font-weight:600;"><?php echo e($row->deducted_at?->format('h:i A') ?? $row->created_at?->format('h:i A') ?? '—'); ?></td>
                                </tr>
                ...
                <div class="ob-summary">
                    <div class="ob-summary-grid">
                        <div class="ob-summary-item">
                            ...
                            <span class="ob-summary-value"><?php echo e($clientName); ?></span>
                        </div>
                        <div class="ob-summary-item">
                            <span class="ob-summary-label">Office/Department</span>
                            <span class="ob-summary-value"><?php echo e($clientOffice); ?></span>
                        </div>
                        <div class="ob-summary-item">
                            <span class="ob-summary-label">Total Items</span>
                            <span class="ob-summary-value"><?php echo e($group->count()); ?></span>
                        </div>
                        <div class="ob-summary-item">
                            <span class="ob-summary-label">Total Quantity</span>
                            <span class="ob-summary-value"><?php echo e($group->sum('total')); ?></span>
                        </div>
                                            </div>
                </div>
            </div>
                    ...
                    <div id="clientDropdownMenu" style="position:absolute; top:100%; left:0; right:0; background:#ffffff; border:2px solid #e2e8f0; border-radius:10px; box-shadow:0 8px 25px rgba(15,23,42,.15); margin-top:4px; max-height:300px; overflow-y:auto; z-index:1000; display:none;">
                        ...
                        <div id="clientOptions">
                            <?php $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="client-option-item" data-type="client" data-client-id="<?php echo e($client->id); ?>" data-client-name="<?php echo e($client->name); ?>" data-client-office="<?php echo e($client->office ?? 'Not specified'); ?>" style="padding:12px 14px; cursor:pointer; border-bottom:1px solid #f1f5f9; transition:background 0.2s ease; font-size:14px; color:#374151;">
                            ...
                            <?php $__currentLoopData = $members; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="client-option-item" data-type="member" data-client-id="<?php echo e($member->client_id); ?>" data-member-id="<?php echo e($member->id); ?>" data-client-name="<?php echo e($member->name); ?>" data-client-office="<?php echo e($member->client->office ?? 'non office member'); ?>" style="padding:12px 14px; cursor:pointer; border-bottom:1px solid #f1f5f9; transition:background 0.2s ease; font-size:14px; color:#374151;">
                                    <div style="font-weight:600; color:#059669;"><?php echo e($member->name); ?></div>
                                    <div style="font-size:12px; color:#64748b; margin-top:2px;">Member of <?php echo e($member->client->name); ?> • Office: <?php echo e($member->client->office ?? 'non office member'); ?></div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/admin/outbound/index.blade.php ENDPATH**/ ?>