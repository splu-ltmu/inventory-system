...
<div class="toolbar" style="position:relative;">
    <div class="toolbar-actions">
        ...
        <form action="<?php echo e(route('inbound.import')); ?>" method="POST" enctype="multipart/form-data" style="display:flex; gap:8px; align-items:center; margin:0;">
            <?php echo csrf_field(); ?>
...
<?php if(session('success')): ?>
    <div style="margin:12px 0; padding:12px; background:rgba(34,197,94,0.08); border:1px solid rgba(34,197,94,0.18); color:var(--green); border-radius:8px;"><?php echo e(session('success')); ?></div>
<?php endif; ?>
<?php if(session('error')): ?>
    <div style="margin:12px 0; padding:12px; background:rgba(239,68,68,0.06); border:1px solid rgba(239,68,68,0.12); color:var(--red); border-radius:8px;"><?php echo e(session('error')); ?></div>
<?php endif; ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/admin/inbound/index.blade.php ENDPATH**/ ?>