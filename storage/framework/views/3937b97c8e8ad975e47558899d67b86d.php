...
<div class="form-container">
    ...
    <form action="<?php echo e(route('admin.users.store')); ?>" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" name="name" id="name" placeholder="Enter client full name" required value="<?php echo e(old('name')); ?>">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group">
            ...
            <input type="email" name="email" id="email" placeholder="Enter email address" required value="<?php echo e(old('email')); ?>">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group">
            ...
            <input type="text" name="office" id="office" placeholder="e.g. Purchasing" value="<?php echo e(old('office')); ?>">
